<template>
  <section>
    ...
    <p>Upload a keyfile from <a href="https://bridge.urbit.org" target="_blank">Bridge↗</a> or a <a href="https://docs.urbit.org/manual/os/basics#moons" target="_blank">moon↗</a>.</p>
